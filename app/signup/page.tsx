      ...
      >
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <p className="text-xl mb-8">Join our community for exclusive beauty services and special offers.</p>
          </motion.div>
          ...
          >
            <p>Already have an account? <Link href="/login" className="font-bold underline hover:text-pink-200 transition-colors">Login here</Link></p>
          </motion.div>
        </div>
      </motion.div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="pt-2">
              ...
              >
                ...
                <Link href="/terms" className="text-primary hover:text-purple-500 font-medium"> Terms of Service</Link> and
                <Link href="/privacy" className="text-primary hover:text-purple-500 font-medium"> Privacy Policy</Link>
              </motion.div>
            </motion.form>
          </div>
        </motion.div>
